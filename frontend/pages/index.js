                          ...
                          {displayFeaturedBlogs.map((blog, index) => (
                            <div key={blog.id} className="group">
                              <article className="bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100 h-full">
                                ...
                                <div className="relative h-48 overflow-hidden">
                                  ...
                                  {blog.category && (
                                    <div className="absolute top-4 left-4">
                                      <span className="bg-primary-500 text-white px-3 py-1 rounded-full text-xs font-semibold uppercase tracking-wider">
                                        {blog.category.name}
                                      </span>
                                    </div>
                                  )}
                                ...
                                <div className="p-6">
                                  {/* Title */}
                                  <h3 className="font-bold text-xl text-navy-800 mb-3 leading-tight hover:text-primary-600 transition-colors duration-300 line-clamp-2">
                                  ...
                                  {/* Excerpt */}
                                  <p className="text-navy-600 leading-relaxed line-clamp-3 mb-4 text-sm">
                                    {blog.excerpt || (blog.content ? blog.content.substring(0, 120) + '...' : 'Revolutionary publications that transformed our understanding of the world...')}
                                  </p>

                                  {/* Meta Info */}
                                  <div className="flex items-center text-xs text-navy-500 mb-4">
                                    <span>{new Date(blog.created_at).toLocaleDateString('en-US', { month: 'short', day: 'numeric' })}</span>
                                    <span className="mx-2">•</span>
                                    <span>{calculateReadTime(blog.content) || 8} min read</span>
                                  </div>
                        ...
                        <>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                            {(search || selectedCategory || tag ? blogs : displayLatestBlogs).map((blog, index) => (
                              <article key={blog.id} className="group bg-white rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border border-gray-100">
                                {/* Image Container */}
                                <div className="relative h-48 overflow-hidden">
                                  <img
                                    src={blog.featured_image || 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80'}
                                ...
                                <div className="p-6">
                                  {/* Title */}
                                  <h3 className="font-bold text-lg text-navy-800 mb-3 leading-tight hover:text-primary-600 transition-colors duration-300 line-clamp-2">
                                    <Link href={`/blog/${blog.slug}`}>
                                      {blog.title}
                                    </Link>
                                  </h3>
                                  ...
                                  <div className="flex items-center justify-between text-xs text-navy-500 mb-4">
                                    ...
                                    <span>{calculateReadTime(blog.content) || 5} min read</span>
                                  </div>
